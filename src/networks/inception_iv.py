...
class Inceptionv4(AbstractCNN):
    def __init__(self, num_classes=185856, n_channels=3, image_shape: tuple[int, int] = (440, 440), k=750, l=1000, m=256, n=384):
        super().__init__(n_channels, image_shape)
        self.num_classes = num_classes
        blocks = []
        blocks.append(Stem(n_channels))
        for i in range(4):
        ...
        flatten_out_size = self.num_classes
